...
public partial class PageAD_ADList2 : AdminPage
{
    ...
    private void BindList()
    {
        ...
        int seq = Format.DataConvertToInt(drplSep.SelectedValue);
        DataSet ds = bllAD.GetList(PageIndex, PageSize, strKeyWord, strPage, position, seq, strSDate, strEDate, strZSDate, strZEDate, strFileType,strIsRecycle, strChecked);
