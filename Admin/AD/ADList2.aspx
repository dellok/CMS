<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master"  CodeFile="ADList2.aspx.cs" Inherits="PageAD_ADList2" %>
    ...
    <div class="div_search">
        <div class="div_search_row">
         ...
         <uc:ADPage  ID="ucPage" runat="server" IsSearch="true"/>
            ...
            <span class="span_search_label">所在页面位置：</span> <span class="span_search_element">
             
  <uc:ADPagePosition id="ucADPosition" runat="server" IsSearch="true"></uc:ADPagePosition>
            </span>
                 <span class="span_search_label">序列：</span> <span class="span_search_element">
         <asp:DropDownList ID="drplSep" runat="server">
          ...
          <span class="span_search_label">点击统计时间：</span> <span class="span_search_element">
                <asp:TextBox ID="TextBox1" runat="server" Width="100px" CssClass="calendarFocus"></asp:TextBox><img
                    alt="单击选择时间" src="../Images/date.gif" class="calendarFocus" onclick="javascript:$('#<%=txtSEndDate.ClientID %>').focus()" />&nbsp; 
            -
                <asp:TextBox ID="TextBox2" runat="server" Width="100px" CssClass="calendarFocus"></asp:TextBox><img
                    alt="单击选择时间" src="../Images/date.gif" class="calendarFocus" onclick="javascript:$('#<%=txtEEndDate.ClientID %>').focus()" />
            </span> 
        </div>
        <div class="div_search_row">
    ...
    <script>
        ...
        function Rnd() {
            ...
            var dd = Math.round(Math.random(-1, 10)*10);
            ...
            <ItemTemplate>
                ...
                <td class="td_grid_col w80">
                 <input  type="button"  class="btn_2k3"     style="color:red"  value="更新缓存"  onclick='openCacheAD("<%#Eval("Page")%>","<%#Eval("Position")%>","<%#Eval("Seq")%>")'/>
                   ...
                   <input  type="text" value='<%#Eval("hit")%> <%#Eval("pv")%>' style="border:0px;width:100px;"/>
                    ...
                    <td class="td_grid_col w150">
                        <a href='<%#string.Format("ADEdit.aspx?{0}={1}",LL.Common.PubConstant.Key_ID, Eval("id"))%>'>
                            【编辑】</a>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" Text="【删除】"  CommandArgument='<%#Eval("FileUrl")%>'
