<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master"   validateRequest="false"  CodeFile="MemberCompanyInfo2.aspx.cs"   EnableEventValidation="true" Inherits="Member_MemberCompanyInfo2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="adminmaster" Runat="Server">
    ...
    <tr>
        ...
        <td  class="right">
            <asp:TextBox ID="txtUseDays" runat="server" Width="57px" Enabled="false"></asp:TextBox>天，<span class="left">到期日期:</span><asp:TextBox 
                ID="txtEnd" runat="server" Width="124px" Enabled="false"></asp:TextBox>&nbsp;&nbsp;&nbsp; 到期后转向用户组:<asp:DropDownList
                ID="drplMemberGroup" runat="server" Width="100px" Enabled="false">
            </asp:DropDownList>
            &nbsp;&nbsp;</td>
    </tr>
    <tr>
    ...
    <asp:DropDownList ID="drplSpaceStyleID" runat="server">
            ...
            *
                ...
                <tr>
                    ...
                    <td  class="right">
                        <asp:TextBox ID="txtTruename" runat="server" Text="111111" Width="300px"></asp:TextBox>*
