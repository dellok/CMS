<%@ Control Language="C#" EnableViewState="false" AutoEventWireup="true" Inherits="FredCK.FCKeditorV2.FileBrowser.Config" %>
<%--
...
<script runat="server">
	...
	public override void SetConfig()
	{
       ...
       // string uploadFolder = "upload";
        ...
        string uploadFolder = "ProductImg";
		...
		HtmlExtensions = new string[] { "html", "htm", "xml", "xsd", "txt", "js","rar","zip","doc","docx" };
		...
		TypeConfig[ "Media" ].AllowedExtensions			= new string[] { "aiff", "asf", "avi", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg","qt", "ram", "rm", "rmi", "rmvb",  "tif", "tiff", "wav", "wma", "wmv" };
