...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'UpFile': oItem = new FCKToolbarButton('UpFile', FCKLang.UpFile, null, FCK_TOOLBARITEM_ICONTEXT, null, true, null); break;
		case 'InsertFile': oItem = new FCKToolbarButton('InsertFile', FCKLang.InsertFile, null, FCK_TOOLBARITEM_ICONTEXT, null, true, null); break;
