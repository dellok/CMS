...
using LL.Model.News;
using System.Data;
public partial class Member_VipWebSite_NewsList : AdminPage
{
    ...
    private void ShowList()
    {
        ...
        int pagesize = 15;
        string where = string.Format(" userid={0} and classid={1}", GetReqMemberID, (int)LL.Common.EnumClass.VipSiteItemsClassID.新闻动态);
