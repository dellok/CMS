<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" 
    CodeFile="SolutionManager.aspx.cs" Inherits="SolutionManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="adminmaster" runat="Server">
 ...
 <asp:Button  ID="btnAdd2" Text="【继续添加解决方案】" runat="server" CssClass="btn_2k3" 
                    onclick="btnAdd2_Click"  />&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;
 <asp:Button  ID="btnReturnNewsList" Text="【返回-解决方案-列表】" runat="server" CssClass="btn_2k3" onclick="btnReturnNewsList_Click" 
                   />&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;
