...
public partial class Member_VipWebSite_NewsManager : AdminPage
{
    BLLphome_ecms_news bllNews = new BLLphome_ecms_news();
    int NewsClassID = (int)LL.Common.EnumClass.VipSiteItemsClassID.新闻动态;
    ...
    {
        string url = string.Format("NewsManager.aspx?userid={0}", GetReqMemberID);
    ...
    {
      string url = string.Format("NewsList.aspx?userid={0}",GetReqMemberID);
