...
public partial class ProductManager : AdminPage
{
    BLLphome_ecms_news bllNews = new BLLphome_ecms_news();
    int NewsClassID = (int)LL.Common.EnumClass.VipSiteItemsClassID.产品展厅;
    ...
    {
      string url = string.Format("ProductList.aspx?userid={0}",GetReqMemberID);
