<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true"
    CodeFile="NewsList.aspx.cs" Inherits="Member_VipWebSite_NewsList" %>
        ...
        <tr>
            <td valign="top" bgcolor="#FFFFFF">
               ...
               <tr class="tr_grid_row">
                        ...
                        <span  >·</span><a href='<%#string.Format("{3}/vipsite/newsdetail.aspx?u={0}_{1}_{2}&Admin=true",Eval("userid"),(int)LL.Common.EnumClass.VipSiteItemsClassID.新闻动态,Eval("id"),SEO.MainDomain)%>' target="_blank">
                                ...
                                <td class="td_grid_col    w120  txtcenter" align="center">
                                    <a  style="width: 60px; color: green;" href='NewsManager.aspx?id=<%#Eval("id")%>&userid=<%#Eval("userid")%>'>
                                        【修改】</a> &nbsp;&nbsp;
