...
using LL.Model.News;
using System.Data;
public partial class SolutionList : AdminPage
{
    ...
    private void ShowList()
    {
        ...
        string where = string.Format(" userid={0} and classid={1} {2}", GetReqMemberID, (int)LL.Common.EnumClass.VipSiteItemsClassID.解决方案,wheretitle);
    ...
    {
        string url = string.Format("SolutionListManager.aspx?userid={0}", GetReqMemberID);
