<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" 
    CodeFile="NewsManager.aspx.cs" Inherits="Member_VipWebSite_NewsManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="adminmaster" runat="Server">
 ...
 <asp:Button  ID="btnAdd2" Text="【继续添加新闻】" runat="server" CssClass="btn_2k3" 
                    onclick="btnAdd2_Click"  />&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;
 <asp:Button  ID="btnReturnNewsList" Text="【返回-公司新闻动态】" runat="server" CssClass="btn_2k3" onclick="btnReturnNewsList_Click" 
                   />&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;
